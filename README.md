# 🏥 CriticalMind — Agentic ICU Clinical Decision Support System

> **Hackathon Project | Gen AI Track**
...
**CriticalMind** is a multi-agent AI pipeline that ingests a patient's full ICU history — structured vitals, lab results, and unstructured clinical notes — and produces a **Diagnostic Risk Report** with:
...
│   │   ├── guideline_corpus_loader.py
│   │   └── vector_store.py
│   ├── agents/
│   │   ├── note_parser_agent.py
│   │   ├── temporal_lab_mapper_agent.py
│   │   ├── guideline_rag_agent.py
│   │   └── chief_synthesis_agent.py
│   ├── safety/
│   │   ├── outlier_detection.py
│   │   ├── confidence_scorer.py
│   │   ├── citation_verifier.py
│   │   └── safety_caveat_injector.py
│   ├── orchestration/
│   │   ├── orchestrator.py
│   │   └── prompt_templates/
│   │       ├── note_parser.txt
│   │       ├── temporal_lab_mapper.txt
│   │       ├── guideline_rag.txt
│   │       └── chief_synthesis.txt
│   └── output/
